...
class MonitorningController extends Controller
{
    ...
    {   
        ...
        return view('monitoring.monitoring', compact('totalTasks', 'tasksFor2days', 'tasksPassedDeadline', 'tasksFor1day', 'regions', 'categories', 'finished', 'regionNames', 'tasks', 'taskAreas'));
    }
}
